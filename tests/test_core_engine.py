"""
Test cases for core engine components (migrated business logic)
"""
...
class TestAudioAnalyzer:
    ...
    def analyzer(self, temp_cache_dir):
        ...
        return AudioAnalyzer(cache_dir=temp_cache_dir, enable_multiprocessing=False)
...
class TestPlaylistEngine:
    ...
    def playlist_engine(self):
        ...
        return PlaylistEngine(presets_dir=None)  # Use default presets
